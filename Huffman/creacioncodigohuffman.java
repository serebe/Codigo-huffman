...
public class creacioncodigohuffman {// se crea el codigo

    public static String codificacion(String entrada) {
        ...
        String codigo = codificacion(entrada, hashMap);
        return codigo;
    }
    ...
    private static String codificacion(String entrada, HashMap<Character, String> arbol) {// se codifica para mostrar en la salida
        String salida = "";
        for (int i = 0; i < entrada.length(); i = i + 1) {
            salida = salida + arbol.get(entrada.charAt(i));
        }
        return salida;
    }
}
